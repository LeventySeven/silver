 ...
 *     `Runtime.callFunctionOn` to stamp a `data-silver-ref="<ref>"` attribute on
 *     that node, then `page.locator('[data-silver-ref="<ref>"]').first()`.
 *
 ...
 * locator; for a frame-scoped ref the stamped `data-silver-ref` attribute is
